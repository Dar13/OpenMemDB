...
An example of the need for a fast and high throughput databases is a problem that was experienced by Zynga 
...
into the insertRecord method of the Data Store object. The general procedure of inserting
