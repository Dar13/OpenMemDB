...
if (result.isSuccess) {
  ...
  a  \\ \inlinecode{vector<int64_t>}, and \inlinecode{DataValue} is a typedef for \inlinecode{TervelData}.
  So with all typedefs removed \inlinecode{m_rows} is actually a \inlinecode{vector<vector<TervelData > >}.
