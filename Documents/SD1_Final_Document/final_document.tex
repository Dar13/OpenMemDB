...
\begin{figure}
  ...
  \caption{A row store and column store side-by-side comparison.\cite{rowstore}}
...
\begin{figure}[H]
  ...
  \caption{A visualization of accessing the same data in a row store versus a column store.}
...
\begin{figure}
  ...
  \textbf{Template for boost variant}
   ...
   \end{lstlisting}
  \cite{boostvariant}
  \caption{Describes the type of data variant will accept} \label{templateboostvar}
\end{figure}

Figure \ref{templateboostvar} shows ** something **?
...
\begin{figure}
  ...
  \end{lstlisting}
  \cite{boostvariant}
  \caption{Improvement on data retrevial, betterthan get function since types are not predefined} \label{visitationexample}
\end{figure}
...
\begin{figure}
  ...
  \cite{boostvariant}
  \caption{Allows the program to create their own type sequence without using variant constructor} \label{typesequence}
\end{figure}
...
\begin{figure}
	...
	\cite{boostvariant}
	\caption{Allows the program to create their own type sequence without using variant constructor} \label{typesequence2}
\end{figure}
...
\begin{figure}
  ...
  \textbf{Example code using binary visitation}
  	...
  	\end{lstlisting}
  \cite{boostvariant}
  \caption{Compares two variant objects} \label{binvisitation}
\end{figure}
...
\begin{figure}
  ...
  \textbf{Example code for multi visitation}
	...
	\end{lstlisting}
  \cite{boostvariant}
  \caption{Compares three or more variant objects} \label{multivisitation}
\end{figure}
