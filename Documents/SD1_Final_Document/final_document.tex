...
\begin{figure}
  ...
  \caption{An example of a row store architecture. \copyright Oracle LEarning Library 2014, reprinted with permission}
\end{figure}
...
\begin{figure}
  ...
  \caption{An example of a column store architecture. \copyright Oracle Learning Library 2014, reprinted with permission}
\end{figure}
...
\begin{figure}
  ...
  \caption{A row store and column store side-by-side comparison. \copyright Oracle Learning Library 2014, reprinted with permission}
\end{figure}
...
\begin{figure}
  ...
  \cite{saphana}
  \caption{A visualization of accessing the same data in a row store versus a column store. \copyright SAP HANA 2015, reprinted with permission}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{Index key abstract concept for keys and data relations \copyright Ramakrishnan 2000, reprinted with permission}
...
\begin{figure}
  ...
  \cite{b+tree}
  \caption{Example of a B Tree with symbols \copyright Morris 1998, reprinted with permission}
  \label{fig:b_tree_ex}
\end{figure}
...
\begin{figure}
  ...
  \cite{b+tree}
  \caption{A graphic depicting the differences between a B-tree and a B+ tree. \copyright Perrone 2012, reprinted with permission}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{Behavior similiar to B+ Tree Structure \copyright Ramakrishnan 2000, reprinted with permission}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{The order of which memory gets allocated on the page \copyright Ramakrishnan 2000, reprinted with permission}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{ISAM insertion \copyright Ramakrishnan 2000, reprinted with permission}
\end{figure}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{ISAM deletion \copyright Ramakrishnan 2000, reprinted with permission}
\end{figure}
...
\begin{figure}
  ...
  \caption{Abtract data structure representation of static hashing \copyright Ramakrishnan 2000, reprinted with permission}
  \cite{ramakrishnan2000database}
\end{figure}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{Example of Extendible Hashing at Depth 2 \copyright Ramakrishnan 2000, reprinted with permission}
\end{figure}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{New bucket is made \copyright Ramakrishnan 2000, reprinted with permission}
\end{figure}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{Directory doubles and the global depth increases to three. \copyright Ramakrishnan 2000, reprinted with permission}
\end{figure}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{Abstract view of bucket splitting \copyright Ramakrishnan 2000, reprinted with permission}
\end{figure}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{Overflowing occurs \copyright Ramakrishnan 2000, reprinted with permission}
...
\begin{figure}
  ...
  \cite{ramakrishnan2000database}
  \caption{Notice that the number of bits increased as well, since $d(i) = d(a) + i$.  \copyright Ramakrishnan 2000, reprinted with permission}
...
\begin{figure}
  ...
  \cite{huffman}
  \caption{Symbols with frequencies as weights data set \copyright Daescu 2012, reprinted with permission} \label{huffman_example}
\end{figure}

Once the data set is prepared it is inserted into a priority queue. In this figure \ref{huffman_example}, the priority 
...
\begin{figure}
  ...
  \cite{huffman}
  \caption{Data set inserted into a priority queue  \copyright Daescu 2012, reprinted with permission} \label{huff_example}
\end{figure}
...
Continuing with figure \ref{huff_example}, the first two leaf nodes are added as children to a parent node whose
...
\begin{figure}
  ...
  \cite{huffman}
  \caption{Complete Huffman Tree from priority queue  \copyright Daescu 2012, reprinted with permission}
\end{figure}
...
\begin{figure}
  ...
  \cite{huffman}
  \caption{Prefix Code Table derived from Huffman Tree  \copyright Daescu 2012, reprinted with permission}
  \label{fig:huffman_prefix_table}
\end{figure}

\par\vspace{\baselineskip}
After the prefix table in figure ]ref{huffman_prefix_table} is applied to the original data set the following result is the compressed
...
\begin{figure}
  ...
  \cite{huffman}
  \caption{Prefix code representation of original data set.  \copyright Daescu 2012, reprinted with permission}
...
\begin{figure}
  ...
  \cite{LZ77_78}
  \caption{Psuedo Algorithm for encoding processes for look-ahead and search buffer \copyright Wikipedia 2015, reprinted with permission}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[scale=.5]{graphics/LZ77_example_window} \label{LZ77_example}
  \cite{LZ77_78}
  \caption{The format is more clearly defined with in this example. \copyright Wikipedia 2015, reprinted with permission}
\end{figure}
\newpage
...
from the look-ahead buffer as since in figure \ref{LZ77_example}.
\par\vspace{\baselineskip}
...
\begin{figure}
  ...
  \caption{A visualization of the C++ memory heirarchy. \copyright Adrian, 2006, reprinted with permission}
\end{figure}
...
if (result.isSuccess) {
  ...
  \begin{figure}
    ...
    \includegraphics[scale=.75]{graphics/libomdb_resultmetadata_layout.png}
