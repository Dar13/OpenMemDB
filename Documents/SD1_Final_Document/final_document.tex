...
These types are called bounded types and derive from the BoundedType concept. To limit the different
types that bounded types can accept the \inlinecode{BOOST_VARIANT_LIMIT_TYPES} must be manipulated to reflect this.
To retrieve data types from \inlinecode{boost::variant} there are multiple functions available in order to accomplish this task.
