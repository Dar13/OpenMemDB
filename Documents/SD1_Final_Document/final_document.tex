...
\begin{figure}[H]
  \centering
  \includegraphics[scale=.55]{graphics/B_Tree_Example.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=.75]{graphics/B_B+_Tree_Difference.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=.75]{graphics/Static_Hashing_Abstract.png}
