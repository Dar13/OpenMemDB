...
\includegraphics{graphics/row_store_column_accessing_data}
...
verify that they meet their individual requirements as well. All of these tests will require 
the use of libomdb, so that part of the system will be tested exhaustively.
\subsection{Data Store}
...
These tests should allow a comprehensive test suite for the Data Store module.
